...
import ExerciseButton from "./ExerciseButton.jsx";

function ExerciseSelector({ selectedExercises, onToggleExercise, getExerciseName }) {
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <input
            ...
            className="w-full p-2.5 pl-9 rounded-lg bg-background-secondary text-secondary 
                     border border-gray-700 focus:outline-none focus:ring-2 focus:ring-primary/50
