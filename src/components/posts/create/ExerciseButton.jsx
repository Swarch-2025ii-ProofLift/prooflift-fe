function ExerciseButton({ exercise, isSelected, onClick }) {
    ...
    <button
      ...
      className={`relative p-4 rounded-xl text-sm font-medium transition-all duration-300
                 ...
                 ${isSelected
                   ...
                   : 'bg-gradient-to-br from-tertiary/40 to-tertiary/20 text-secondary border-gray-700/50 hover:border-primary/40 hover:shadow-md hover:from-tertiary/60 hover:to-tertiary/30'
                 }`}
      title={exercise.name}
    >
